...
public class ReceivedListData {
    ...
    public ReceivedListData(String a, String b, String c, String d, String e, String f) {
        receiverNo = new SimpleStringProperty(a);
        callerNo = new SimpleStringProperty(b);
